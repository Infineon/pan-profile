...
#define BNEP_MAX_XMITQ_DEPTH        5
#endif

/* Maximum number BNEP of connections supported. */
#ifndef BNEP_MAX_CONNECTIONS
#define BNEP_MAX_CONNECTIONS        1
#endif

#ifndef BNEP_MAX_NUM_XMIT_BUF
#define BNEP_MAX_NUM_XMIT_BUF         10
#endif

#ifndef BNEP_XMIT_PENDING_HIGH_DEPTH
#define BNEP_XMIT_PENDING_HIGH_DEPTH   7
#endif

#ifndef BNEP_XMIT_PENDING_LOW_DEPTH
#define BNEP_XMIT_PENDING_LOW_DEPTH    3
#endif
